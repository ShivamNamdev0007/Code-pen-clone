...
function CodeArea() {
  ...
  return (
    <main className='main2'>
        ...
        <TextArea value={html} onChange={setHtml} type={"/"} bg={"red"} name={"HTML"}/>
        <TextArea value={css} onChange={setCss} type={"*"} bg={"#1CE4E4"} name={"CSS"}/>
        <TextArea value={js} onChange={setJs} type={"{ }"} bg={"yellow"} name={"JS"}/>
                </section>
